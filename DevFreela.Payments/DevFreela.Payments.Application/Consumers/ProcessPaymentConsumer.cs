...
namespace DevFreela.Payments.Application.Consumers
{
    public class ProcessPaymentConsumer : BackgroundService
    {
        ...
        protected override Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            consumer.Received += async (sender, eventArgs) =>
            {
                ...
                var paymentInfo = JsonSerializer.Deserialize<Payment>(paymentInfoJson);
                ...
                var paymentAprovedBytes = Encoding.UTF8.GetBytes(paymentApprovedJson);

                _channel.BasicPublish(
                    exchange: "",
                    routingKey: PAYMENT_APPROVED_QUEUE,
                    basicProperties: null,
                    body: paymentAprovedBytes);
        ...
        public async Task ProcessPayment(Payment paymentInfo)
        {
